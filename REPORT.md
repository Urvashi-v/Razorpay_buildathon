...
final: there is no fairness audit, no order ingestion, no console and no outcome
loop yet.
...
- [docs/api.md](docs/api.md) — the serving surface, with real request and response
  examples captured against PostgreSQL and a loaded artefact.
